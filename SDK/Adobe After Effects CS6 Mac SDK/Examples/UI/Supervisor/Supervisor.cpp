...
/*
	...
	=======		======										========	======
	1.0			created										bbb			9/1/00

	1.1			updated for 16bpc							bbb			2/14/01

	1.2			added use of START_COLLAPSED_FLAG,			bbb			9/1/01
				fixed a supervision logic bug or two...								
				
	1.3			Fixed usage of initializedB flag			bbb			1/1/02
	
	2.0			Bumped version number higher to 			bbb			2/20/03
				reflect a bunch of changes. Adding
				lots of comments.

	3.0			Replaced param supervision with whizzy		bbb			5/7/03
				new DynamicStreamSuite calls.
				
	4.0			I am so SMRT! I am so SMRT1 S-M-R-T!		bbb			10/4/06
				No, wait...S-M-A-R-T!

	5.0			Premiere Pro compatibility					zal			2/20/08

	5.1			Better param supervision logic				zal			5/28/09

	5.2			Demonstrate renaming choices in popup param	zal			6/2/09

	5.5			64-bit										zal			2/2/10

	5.6			Demonstrate HaveInputsChangedOverTimeSpan	zal			4/20/11

	5.7			Demonstrate changing param values			zal			6/22/11
