...
#define PF_AE_PLUG_IN_VERSION				PF_AE110_PLUG_IN_VERSION
#define PF_AE_PLUG_IN_SUBVERS				PF_AE110_PLUG_IN_SUBVERS
...
enum {
	...
	// following flags are currently ignored in AE but may be honored by other hosts
	PF_PUI_RADIO_BUTTON			= 1L << 8,	// display as a radio-button group; only valid for PF_Param_POPUP

	PF_PUI_INVISIBLE			= 1L << 9	// Hides parameters UI.  In Premiere, this flag is dynamic 
											// and can be used to make the parameter visible again.
};
